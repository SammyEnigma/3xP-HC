...
init()
{
	...
	level.hardpointHints["nuke_mp"] = "Press [{+actionslot 4}] for NUKE";
	...
	level.hardpointHints["nuke_mp_not_available"] = "STRAFE RUN not available";
...
hardpointNotify( hardpointType, streakVal )
{
	...
	notifyData.titleLabel = &"MP_KILLSTREAK_N";
	notifyData.titleText = streakVal;
	if(hardpointType == "predator_mp" || hardpointType == "strafe_mp" || hardpointType == "carepackage_mp" || hardpointType == "artillery_mp"|| hardpointType == "nuke_mp" || hardpointType=="orbital_mp")
		...
		switch( currentWeapon )
		{
			...
			case "helicopter_mp":
				...
				{	
					...
					if(self.pers["hardPointItem"] != "predator_mp" && self.pers["hardPointItem"] != "strafe_mp" && self.pers["hardPointItem"] != "carepackage_mp"  && self.pers["hardPointItem"] != "artillery_mp" && self.pers["hardPointItem"] != "nuke_mp" && self.pers["hardPointItem"] != "orbital_mp")
...
triggerHardPoint( hardpointType )
{
	...
	else if ( hardpointType == "radar_mp" && self.pers["hardPointItem"] == "nuke_mp")
	{
		if(self duffman\_nuke::canCallNuke())
			self streakWarning("NUKE_INCOMING","FRIENDLY_NUKE","ENEMY_NUKE");
		else {
			self iPrintBig("NUKE_NOT_AVAILABLE");
			return false;
		}
	}
