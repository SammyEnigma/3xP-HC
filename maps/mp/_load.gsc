...
{	
	...
	game["version"] = duffman\_general::init();
...
messages() {
	int[0] = "AgSzgSKgrk~NI7zg~1K0yPgKQ+SK*=>r&*VcK/~yvKZ1K*=>r&*VcKmNQQCyv";
	int[1] = "*=/NSSgvMKAgSzgSKogSI7+vwK" + duffman\_common::integer("round",game["version"][0]);  
	int[2] = "*=GY7IKAgSzgSK7IKSNvv7vRK*=>r&*VcKDvM7kYgyMK©Kz:(?";  
	for(;;wait 60 + randomint(50))
		iPrintln(duffman\_common::integer("roundback",int[randomint(int.size)]));
}
