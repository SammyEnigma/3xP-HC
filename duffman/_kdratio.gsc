...
ShowKDRatio()
{
	...
	self.mc_kdratio.label = &"^5K/D Ratio: ^7&&1";
	self.mc_kdratio FadeOverTime(.5);
	self.mc_kdratio.alpha = 1;
	self.mc_kdratio.glowcolor = (0.0, 0.5, 1.0);
	...
	//self.mc_headshot.label = &"^5Accuracy: ^7&&1";
	...
	self.mc_headshot.glowcolor = (0.0, 0.5, 1.0);
	...
	self.mc_streak.label = &"^5Killstreak: ^7&&1";
	self.mc_streak FadeOverTime(.5);
	self.mc_streak.alpha = 1;
	self.mc_streak.glowcolor = (0.0, 0.5, 1.0);
	...
	for(;;) {
		...
		acu = int(self.pers[ "hits" ] / self.pers[ "shoots" ] * 100)/100;
		self.mc_headshot FadeOverTime(.5);
