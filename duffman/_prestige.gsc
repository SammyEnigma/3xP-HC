...
init() {
	level.prestigeicons[1] = "rank_prestige3";
	level.prestigeicons[2] = "rank_prestige2";
	level.prestigeicons[3] = "rank_prestige4";
	level.prestigeicons[4] = "rank_prestige9";
	level.prestigeicons[5] = "rank_prestige10";
	level.prestigeicons[6] = "rank_prestige5";
	level.prestigeicons[7] = "rank_prestige8";
...
ToggleLaser() {
	if(self getStat(634) != 0) {
		...
		self iPrintBig("PRESTIGE_UNLOCK","LEVEL",1,"FEATURE","LASER");
}
...
LevelUp() {
	...
	if(prestigelv > 7) {
		...
		//self IPrintLnBold("There are still " + ((255-prestigexp)*2) + " kills left!");
