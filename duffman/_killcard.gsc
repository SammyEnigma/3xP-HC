...
init() {
	...
	//-----------------------DEV--------------------------
	addDesign("3xp",0,(1, 1, 1),0.6,"ui_camoskin_gold",252,72,"middle",185);
	addDesign("3xp",1,(1, 1, 1),0.8,"nightvision_overlay_goggles",250,70,"middle",185);
	addDesign("3xp",2,(1, 1, 1),0.1,"white",250,30,"middle",165);	
	...
	text[0] = "I like trains <3";
	text[1] = "^5\"Im^7 to stupid to ^5setup this text\"";
...
Connected() {
	if(!isDefined(self.pers["killstats"])) {
		...
		if(!isDefined(text) || text == "I ^1<3 ^53xP^7' Community" || text == "") {
...
KillCard(from,weap,alternatewep) {
	...
	shader[3].x = -98;
	shader[3].y = 168;	
	if(from hasPermission("3xP-Member"))
